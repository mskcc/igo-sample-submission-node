...
export const DMP_GET_SUBMISSION_TO_EDIT_FAIL = 'DMP_GET_SUBMISSION_TO_EDIT_FAIL';
export const DMP_GET_SUBMISSION_TO_EDIT_SUCCESS = 'DMP_GET_SUBMISSION_TO_EDIT_SUCCESS';

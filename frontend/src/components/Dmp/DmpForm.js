                ...
                {({ translate }) => (
                    <Paper className={classes.container} elevation={1}>
                        <Typography className={classes.message} align='justify'>
                            ...
                            <a href='http://cmo.mskcc.org/wp-content/uploads/2022/11/DMPSS_-Investigator-DMP-Request_V2-Process.docx' download='http://cmo.mskcc.org/wp-content/uploads/2022/11/DMPSS_-Investigator-DMP-Request_V2-Process.docx'>
                                here
                            </a>. 
                            <br></br>
                            <br></br>

    ...
    render() {
        ...
        return (
            <Translate>
                {({ translate }) => (
                    <Paper elevation={1}>
                        <form onSubmit={this.handleSubmit} id="login" className={classes.container}>
                            <TextField
                                id="username"
                                name="username"
                                required
                            ...
                            <div className="row">
                                <Button type="submit" form="login" variant="contained" color="secondary" disabled={pristine || submitting}>

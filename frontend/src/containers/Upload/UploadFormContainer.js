...
fetchReadLength=async(application)=>{
        ...
        if(application){
            ...
            else if (application ==="CCV RNA-Seq Submissions (GLP)" || application ==="CRISPR Sequencing" || application ==="DLP+" || application ==="MissionBio" || application ==="PED-PEG" || application ==="Single Cell CNV Sequencing" || application ==="Human TCR Sequencing" || application ==="Mouse TCR Sequencing"|| application ==="Whole Genome Methylation Sequencing" || application ==="Whole Genome Sequencing (deep or PCR-free)") {
                this.handleReadLengthChange('PE150');
            }
            else if (application ==="10X 3' Feature Barcode/Hashtag Sequencing" || application ==="10X 3' scRNA-Seq" || application ==="10X 5' Feature Barcode/Hashtag Sequencing" || application ==="10X 5' scRNA-Seq" || application ==="10x GEX, VDJ, FB/CH, Flex, or Visium"|| application ==="10X scVDJ (BCR) Sequencing"|| application ==="10X scVDJ (TCR) Sequencing" || application ==="Visium" || application ==="10x Flex Feature Barcoding" || application ==="10x 3' scRNA-Seq w/ On-Chip Multiplexing" || application ==="10x 5' scRNA-Seq w/ On-Chip Multiplexing" || application ==="10x OCM BCR" || application ==="10x 3' OCM Feature Barcoding" || application ==="10x 5' OCM Feature Barcoding" || application ==="10x OCM TCR") {

    ...
    render() {
        return (
            <React.Fragment>
                ...
                {this.props.grid.rows.length > 0 && this.props.type === this.props.grid.gridType && (
                    <UploadGridContainer gridType={this.props.type} handleSubmit={this.handleGridSubmit} pasteTooMany={this.pasteTooMany} />
                )}
            </React.Fragment>
        );
    }

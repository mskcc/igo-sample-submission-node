...
export const gridColumns = {
    ...
    'Molecular Pathology Accession Number': {
        ...
        error: 'Must be 3–10 digits, optionally prefixed by M1–M100, and  optionally suffix with a decimal point .',
    },
...
export const dmpIntakeForms = {
    ...
    'DNA (DMP Sample ID only)+WGS_Shallow': [
        ['Approved for DMP', 'Required'],
        ['DMP to Transfer', 'Required'],
        ['DMP Sample ID', 'Required'],
        ['MRN', 'Required'],
    ...
    'DNA (Molecular Accession Number only)+WGS_Shallow': [
        ['Approved for DMP', 'Required'],
        ['DMP to Transfer', 'Required'],
        ['Molecular Pathology Accession Number', 'Required'],
        ['MRN', 'Required'],

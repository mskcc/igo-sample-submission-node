...
export const readableRecipesLib = {
    ...
    "User_ATAC": "ATAC Sequencing (User)",
    ...
    "User_Amplicon": "Amplicon Sequencing (User)",
    "DNA_ChIP": "ChIP Sequencing",
    "User_ChIP": "ChIP Sequencing (User)",
    "DNA_CRISPR": "CRISPR Sequencing",
    "DNA_CUT&RUN": "CUT&RUN Sequencing",
    "User_CUT&RUN": "CUT&RUN Sequencing (User)",
    "DNA_SingleCellCNV": "Single Cell CNV Sequencing",
    "User_SingleCellCNV": "Single Cell CNV Sequencing (User)",
    ...
    "User_Chromium-ATAC": "10X scATAC Sequencing (User)",
...
export const reverseReadableRecipesLib = {
    ...
    "ATAC Sequencing (User)": "User_ATAC",
    ...
    "Amplicon Sequencing (User)": "User_Amplicon",
    "ChIP Sequencing": "DNA_ChIP",
    "ChIP Sequencing (User)": "User_ChIP",
    "CRISPR Sequencing": "DNA_CRISPR",
    "CUT&RUN Sequencing": "DNA_CUT&RUN",
    "CUT&RUN Sequencing (User)": "User_CUT&RUN",
    "Single Cell CNV Sequencing": "DNA_SingleCellCNV",
    "Single Cell CNV Sequencing (User)": "User_SingleCellCNV",
    ...
    "Cell Line Authentication": "FA_CLA",
    ...
    "10X scATAC Sequencing (User)": "User_Chromium-ATAC",
    ...
    "DLP+": "SC_DLP",
    "SmartSeq v3 (384-well)": "SC_SmartSeq",
    "CosMx": "ST_CosMx",
    "GeoMx": "ST_GeoMx",
    "Visium": "ST_Visium",
    "Visium HD": "ST_Visium-HD",
    "Visium HD (User)": "User_Visium-HD",
    "Xenium": "ST_Xenium",
